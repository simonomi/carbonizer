...
func assert(declaration: String, parsesTo expectedResult: [Property]) throws {
	...
	var actualResult = try parseProperty(declaration)
...
@Test
fileprivate func padding() throws {
	try assert(
...
@Test
fileprivate func ifCondition() throws {
	try assert(
...
@Test
fileprivate func endOffset() throws {
	try assert(
