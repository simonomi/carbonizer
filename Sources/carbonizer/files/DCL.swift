...
fileprivate let vivosaurNames = ["", "T-Rex", "Daspleto", "Gorgo", "Tarbo", "Alio", "Siamo", "Alectro", "Guan", "Shanshan", "Allo", "Metria", "Megalo", "Venator", "S-Raptor", "Giganto", "Cryo", "Carchar", "Acro", "F-Raptor", "Spinax", "Neo", "Compso", "Sopteryx", "Delta", "Tro", "Nychus", "M-Raptor", "U-Raptor", "V-Raptor", "Breme", "Aopteryx", "Coelo", "Dilopho", "Spino", "Angato", "Sucho", "Onyx", "Cerato", "Carno", "Orno", "Cheirus", "O-Raptor", "Zino", "Brachio", "Salto", "Shuno", "Perso", "Seismo", "Apato", "Amargo", "Stego", "Yango", "Jiango", "Kentro", "Lexo", "Nodo", "Ankylo", "Saichan", "Goyle", "Pelto", "Hypsi", "Nasaur", "Igua", "Ourano", "Lambeo", "Maia", "Anato", "Paraloph", "Pachy", "Stygi", "Goyo", "Proto", "Tricera", "Styraco", "Einio", "Centro", "Penta", "Pachrino", "Mihu", "Ptera", "Coatlus", "Jara", "Dimorph", "Guera", "Krona", "Futabi", "Elasmo", "Plesio", "Shoni", "Arsith", "Brontoth", "Elasmoth", "Hoplo", "Andrarch", "Paki", "Smilo", "Mammoth", "Tryma", "Megath", "Chelon", "Dinomaton", "Duna", "Raptin", "Dynal", "Frigi", "Igno", "Squik", "Squirk", "Squirth", "Squilk", "Squiro", "Guhweep", "Guhvorn", "Guhlith", "OP Frigi", "OP Igno"]
