...
//func CreateFileSystemObject(contentsOf path: URL) throws -> (any FileSystemObject, InputPackedStatus) {
//	switch try path.type() {
//		case .file:
...
//struct File: FileSystemObject, Sendable {
//	var name: String
...
//					case "MAR":
//                        if globalMutableState.extractMARs.shouldExtract {
