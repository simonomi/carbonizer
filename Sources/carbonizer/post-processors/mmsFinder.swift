...
////		)
//		
//		let animationArchive = parent.contents.first { $0.name == mms.animation.tableName } as! File
//		let animationMAR = animationArchive.data as! MAR
//		
...
//			
//			let colorPaletteArchive = parent.contents.first { $0.name == mms.colorPalette.tableName } as! File
...
//				}
//				
//				let colorPaletteFile = colorPaletteMAR.files[Int(colorPaletteIndex)]
...
//			}
//			
//			let bitmapArchive = parent.contents.first { $0.name == mms.bitmap.tableName } as! File
//			let bitmapMAR = bitmapArchive.data as! MAR
//			
//			let bitmaps: [SpriteBitmap] = try mms.bitmap.indices.map { bitmapIndex in
//				let bitmapFile = bitmapMAR.files[Int(bitmapIndex)]
...
//			}
//			
//			let animationFile = animationMAR.files[animationIndex]
