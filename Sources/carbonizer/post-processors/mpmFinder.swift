...
//		
//		let colorPaletteArchive = parent.contents.first { $0.name == mpm.entry1.tableName } as! File
...
//		
//		let bitmapArchive = parent.contents.first { $0.name == mpm.entry2.tableName } as! File
