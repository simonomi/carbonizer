...
extension DAL.Packed: ProprietaryFileData {
	...
	func unpacked(configuration: Configuration) -> DAL.Unpacked {
		DAL.Unpacked(self, configuration: configuration)
	}
	
	fileprivate init(_ unpacked: DAL.Unpacked, configuration: Configuration) {
...
extension DAL.Unpacked: ProprietaryFileData {
	...
	fileprivate init(_ packed: DAL.Packed, configuration: Configuration) {
