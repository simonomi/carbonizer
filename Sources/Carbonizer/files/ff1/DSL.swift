...
extension DSL.Packed: ProprietaryFileData {
	...
	func unpacked(configuration: Configuration) -> DSL.Unpacked {
		DSL.Unpacked(self, configuration: configuration)
	}
	
	fileprivate init(_ unpacked: DSL.Unpacked, configuration: Configuration) {
...
extension DSL.Unpacked: ProprietaryFileData {
	...
	fileprivate init(_ packed: DSL.Packed, configuration: Configuration) {
