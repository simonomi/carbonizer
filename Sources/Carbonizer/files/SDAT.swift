...
extension SDAT.Packed: ProprietaryFileData {
	...
	func unpacked(configuration: CarbonizerConfiguration) -> SDAT.Unpacked {
		SDAT.Unpacked(self, configuration: configuration)
	}
	
	fileprivate init(_ unpacked: SDAT.Unpacked, configuration: CarbonizerConfiguration) {
		todo()
	}
}
...
extension SDAT.Unpacked: ProprietaryFileData {
	...
	func packed(configuration: CarbonizerConfiguration) -> SDAT.Packed {
		SDAT.Packed(self, configuration: configuration)
	}
	
	func unpacked(configuration: CarbonizerConfiguration) -> Self { self }
	
	fileprivate init(_ packed: SDAT.Packed, configuration: CarbonizerConfiguration) {
