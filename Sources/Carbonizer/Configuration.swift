...
extension Carbonizer {
	public struct Configuration: Sendable {
		...
		public init(overwriteOutput: Bool, dexCommandList: DEXCommandList, externalMetadata: Bool, fileTypes: Set<String>, onlyUnpack: [Glob], skipUnpacking: [Glob], experimental: ExperimentalOptions, logHandler: (@Sendable (String) -> Void)?) {
